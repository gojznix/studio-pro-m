...
const AdBanner = ({ advertisement, timeRemaining }: AdBannerProps) => {
  ...
  return (
    <Card className="backdrop-blur-3xl bg-gradient-to-r from-purple-500/20 to-indigo-500/20 border border-purple-400/30 shadow-[0_8px_32px_rgba(139,69,193,0.2)] p-4 rounded-xl relative overflow-hidden">
      ...
      <div className="relative z-10 flex items-center justify-between">
        <div className="flex items-center space-x-4">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-purple-400 font-bold text-sm uppercase tracking-wide">Advertisement</span>
          </div>
          <div>
